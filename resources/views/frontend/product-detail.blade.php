...
<section id="aa-catg-head-banner">
    <img src="{{$product->thumbnail}}" alt="fashion img">
                                    ...
                                    <li class="">
                                        <figure>
                                            ...
                                            <figcaption>
                                                ...
                                                <span
                                                    class="aa-product-price">{{number_format(($item->price-(($product->price*10)/100)))}} VND</span>
                                                <span class="aa-product-price"><del>{{number_format($item->price)}} VND</del></span>
                                            </figcaption>
                                        </figure>
