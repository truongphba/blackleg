...
<section id="aa-catg-head-banner">
    <img src="{{$category->thumbnail}}" alt="fashion img">
                                ...
                                <li class="">
                                    <figure>
                                        ...
                                        <figcaption>
                                            ...
                                            <span
                                                class="aa-product-price">{{number_format(($product->price-(($product->price*10)/100)))}} VND</span>
                                            <span class="aa-product-price"><del>{{number_format($product->price)}} VND</del></span>
                                        </figcaption>
                                    </figure>
                            ...
                            <ul>
                                @foreach($categories as $cate)
                                    @foreach($cate->product as $product)
                                        @if($product->highlight == 1 && $cate->id == $product->category_id)
                                            <li>
                                                <a href="{{route('productDetail', $product->id)}}"
                                                   class="aa-cartbox-img"><img style="object-fit: contain !important;" alt="img" src="{{$product->thumbnail}}"></a>
                                                <div class="aa-cartbox-info">
                                                    <h4>
